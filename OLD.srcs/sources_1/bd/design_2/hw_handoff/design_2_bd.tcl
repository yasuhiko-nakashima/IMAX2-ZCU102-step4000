...
proc create_root_design { parentCell } {
  ...
  # Create instance: rst_300MHz, and set properties
  set rst_300MHz [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_300MHz ]
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins axi_smc/aclk1] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins emax6_0/ACLK] [get_bd_pins rst_200M/slowest_sync_clk]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins emax6_0/ARESETN] [get_bd_pins rst_200M/peripheral_aresetn]
  connect_bd_net -net rst_ps8_0_299M_interconnect_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins rst_300MHz/interconnect_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_smc/aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins rst_300MHz/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins rst_200M/ext_reset_in] [get_bd_pins rst_300MHz/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]

  # Create address segments
  create_bd_addr_seg -range 0x000100000000 -offset 0x000400000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs emax6_0/axi_s/reg0] SEG_emax6_0_reg0
