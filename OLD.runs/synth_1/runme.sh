...
HD_PWD='/home/nakashim/proj-arm64/fpga/ZCU102-step4000/ZCU102_8st.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_wrapper.vds -m64 -stack 10000  -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_wrapper.tcl
