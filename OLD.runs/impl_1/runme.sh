...
HD_PWD='/home/nakashim/proj-arm64/fpga/ZCU102-step4000/ZCU102_8st.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_wrapper.vdi -applog -m64 -stack 10000  -product Vivado -messageDb vivado.pb -mode batch -source design_2_wrapper.tcl -notrace
